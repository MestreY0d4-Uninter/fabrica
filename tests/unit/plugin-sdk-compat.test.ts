...
const TAR_HEADER = Buffer.from("", "base64");
...
describe("plugin-sdk-compat", () => {
  ...
  it("detects TAR when the signature lives later in the file", async () => {
    await expect(
      detectMime({ buffer: TAR_HEADER }),
