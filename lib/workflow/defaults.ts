  ...
  states: {
    ...
    toReview: {
      ...
      on: {
        ...
        [WorkflowEvent.APPROVED]: { target: "toTest" },
        [WorkflowEvent.SKIP]: { target: "toTest" },
    ...
    reviewing: {
      ...
      color: "#c5def5",
      on: {
        [WorkflowEvent.APPROVE]: { target: "toTest" },
    ...
    toTest: {
      ...
      on: {
        ...
        [WorkflowEvent.SKIP]: { target: "done", actions: [Action.MERGE_PR, Action.GIT_PULL, Action.CLOSE_ISSUE] },
        [WorkflowEvent.MERGE_FAILED]: "toImprove",
      },
    },
    testing: {
      ...
      color: "#9b59b6",
      on: {
        [WorkflowEvent.PASS]: { target: "done", actions: [Action.MERGE_PR, Action.GIT_PULL, Action.CLOSE_ISSUE] },
