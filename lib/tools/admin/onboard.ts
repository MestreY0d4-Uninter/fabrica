/**
 * onboard — Conversational Fabrica onboarding.
 *
...
export function createOnboardTool(ctx: PluginContext) {
  return (toolCtx: ToolContext) => ({
    name: "onboard",
    label: "Onboard",
    description: "Start Fabrica onboarding workflow. Returns step-by-step QA-style guidance. Call this first, then setup with collected answers.",
    parameters: {
      type: "object",
      properties: {
