/**
 * setup — Agent-driven Fabrica setup.
 *
...
export function createSetupTool(ctx: PluginContext) {
  return (toolCtx: ToolContext) => ({
    name: "setup",
    label: "Setup",
    description: `Execute Fabrica setup. Creates AGENTS.md, HEARTBEAT.md, TOOLS.md, fabrica/projects.json, fabrica/prompts/, and model level config. Optionally creates a new agent with channel binding. Called after onboard collects configuration.`,
    parameters: {
      type: "object",
      properties: {
        newAgentName: {
