...
EOF
  ...
  # qa.sh is generated by TypeScript (qa-contracts.ts) after scaffold
  mkdir -p scripts
  echo '#!/usr/bin/env bash' > scripts/qa.sh
  echo '# Placeholder — will be overwritten by Fabrica plugin' >> scripts/qa.sh
  chmod +x scripts/qa.sh
  FILES_CREATED+=("scripts/qa.sh")
}
